<!-- resources/views/prescricao/create.blade.php -->
<x-app-layout>
    <div class="container" style="max-width: 600px; margin-top: 40px;">
        <div class="card shadow-sm p-4" style="border-radius: 15px; background-color: #f8f9fa;">
            <h2 class="text-center mb-4" style="color: #4a5568;">Nova Prescrição</h2>
            <form action="{{ route('prescricao.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="descricao" id="descricao" class="form-control" required style="border-radius: 10px; border-color: #cbd5e0;"></textarea>
                </div>
