    ...
    <div class="container" style="max-width: 600px; margin-top: 40px;">
        <div class="card shadow-sm p-4" style="border-radius: 15px; background-color: #f8f9fa;">
            ...
            <div class="form-group mb-3">
                ...
                <p id="nome" class="form-control" style="border-radius: 10px; border-color: #cbd5e0;">
                    {{ $pacientes->nome }}
                </p>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <p id="endereco" class="form-control" style="border-radius: 10px; border-color: #cbd5e0;">
                    {{ $pacientes->endereco }}
                </p>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <p id="telefone" class="form-control" style="border-radius: 10px; border-color: #cbd5e0;">
                    {{ $pacientes->telefone }}
                </p>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <p id="email" class="form-control" style="border-radius: 10px; border-color: #cbd5e0;">
                    {{ $pacientes->email }}
                </p>
            </div>
            ...
            <div class="form-group text-center">
                <a href="{{ route('pacientes.index') }}" class="btn btn-secondary" style="padding: 10px 20px; border-radius: 10px; background-color: #6c757d; border-color: #6c757d; font-weight: 600;">
                    Voltar
                </a>
            </div>
        </div>
